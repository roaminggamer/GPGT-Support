...
// ******************************************************************
//
// 1. Give the player 3 lives to begin with.
// 2. Build the 0th level.
// 3. Start the 'check for end of game loop' in 5 seconds
//
function go()
{
   // 1
   ...
   // 3   
   schedule( 5000 , MissionGroup , advanceLevel );
...
// ******************************************************************
//
// 1. Check for the 'end of level' (no coins left).
// 1a. Build the next level.
// 1b. Start the 'check for end of level' loop again in 5 seconds
// 1c. Give the player another life.
// 2. Level is not over, schedule another check in 1/2 second
//
function advanceLevel()
{
   ...
   // 2
   schedule( 500 , MissionGroup, advanceLevel );
}

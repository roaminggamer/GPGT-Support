...
function onServerCreated()
{
   ...
   exec("./MazeRunner/killzone.cs"); // MazeRunner - B Finishing GamePlay
...
function onMissionLoaded()
{
   ...
   buildKillZone(); // MazeRunner - B Finishing GamePlay
   startGame();
}
...
function GameConnection::createPlayer(%this, %spawnPoint)
{
   ...
   $Game::Player = %player; //MazeRunner - B Finishing GamePlay

...
//   exec("./aiPlayer.cs");
   ...
   exec("./MazeRunner/killzone.cs"); // MazeRunner
   exec("./MazeRunner/leveleditor.cs"); // Advanced
   exec("./MazeRunner/precipitation.cs"); // Advanced
...
function GameConnection::onClientEnterGame(%this)
{
   ...
   $Game::Client = %this; // Advanced
   $Game::Camera = %this.camera; // Advanced

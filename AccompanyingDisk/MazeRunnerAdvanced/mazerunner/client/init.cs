...
function initClient()
{
   ...
   // load time.
   initCanvas("Maze Runner Advanced (Alpha) - The Game Programmer's Guide to Torque", true);

   /// Load client-side Audio Profiles/Descriptions
   exec("./scripts/audioProfiles.cs");

   exec("./ui/MazeRunnerProfiles.cs"); // MazeRunner

   // Load up the Game GUIs
   exec("./ui/defaultGameProfiles.cs");
   // exec("./ui/PlayGui.gui"); // MazeRunner
   exec("./ui/ChatHud.gui");
   exec("./ui/playerList.gui");

   // Load up the shell GUIs
   //exec("./ui/mainMenuGui.gui"); // MazeRunner
   exec("./ui/Splash/Splash.cs"); // MazeRunner
   exec("./ui/Splash2/Splash.cs"); // MazeRunner
   exec("./ui/Splash3/Splash.cs"); // MazeRunner
   exec("./ui/mainMenu/mainMenu.cs"); // MazeRunner
   exec("./ui/credits/credits.cs"); // MazeRunner
   exec("./ui/PlayGUIs/playGui.cs"); // MazeRunner
   exec("./ui/QuitGui.gui");
   ...
   exec("./ui/EditorMessageGui.gui");
   //exec("./ui/StartupGui.gui"); // MazeRunner   
   ...
   //exec("./scripts/playGui.cs"); // MazeRunner   
...
function loadMainMenu()
{
   ...
   Canvas.setContent( MainMenu ); // MazeRunner

...
datablock ParticleData(baseSmokePD0)
{
	...
	//
   textureName          = "~/data/ParticleTextures/smoke";
...
{
   textureName          = "~/data/ParticleTextures/smokeParticle";
};
...
{
   textureName          = "~/data/ParticleTextures/fire";
};

datablock ParticleData(baseAnimatedFirePD0)
{
   animTexName[0]      = "~/data/ParticleTextures/niceflame0";
   animTexName[1]      = "~/data/ParticleTextures/niceflame1";
   animTexName[2]      = "~/data/ParticleTextures/niceflame2";
   animTexName[3]      = "~/data/ParticleTextures/niceflame7";
   animTexName[4]      = "~/data/ParticleTextures/niceflame3";
   animTexName[5]      = "~/data/ParticleTextures/niceflame4";
   animTexName[6]      = "~/data/ParticleTextures/niceflame5";
   animTexName[7]      = "~/data/ParticleTextures/niceflame6";
   framesPerSec        = 4;
};
...
{
   textureName          = "~/data/ParticleTextures/spark";
};
...
{
   textureName          = "~/data/ParticleTextures/bubble";
};
...
{
   textureName          = "~/data/ParticleTextures/dust";
};

...
lessonActionMap.bind(keyboard, "2", "selectHoverBox");
lessonActionMap.bind(keyboard, "3", "selectFlyingBox");
...
LessonMessageText.addText( "Press '2' to select the hover box.<br>" , true ); // Add messages
LessonMessageText.addText( "Press '3' to select the flying box.<br><br>" , true ); // Add messages

...
datablock DebrisData(TwoDeeDebris) {
	...
	texture				= expandFilename("~/data/shapes/Debris/2DDebrisTexture.png");
	//shapeFile			= "~/data/shapes/Debris/3DDebrisShape.dts";
...
datablock DebrisData(SlidingDebris : BasicThreeDeeDebris) {
 ...
 shapeFile			= "~/data/shapes/Debris/3DDebrisShapeBig.dts";

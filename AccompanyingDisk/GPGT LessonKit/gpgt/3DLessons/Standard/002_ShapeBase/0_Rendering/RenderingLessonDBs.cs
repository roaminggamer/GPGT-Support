...
datablock StaticShapeData( markerBox )
{
   ...
   shapeFile				= "~/data/shapes/Markers/markerBox.dts";
};

datablock StaticShapeData( FadeEgg )
{
   category				= "LessonShapes";
   shapeFile				= "~/data/shapes/markers/Eggs/egg.dts";
};
...
datablock StaticShapeData( CloakEgg )
{
   category				= "LessonShapes";
   shapeFile				= "~/data/shapes/markers/Eggs/egg.dts";
   cloakTexture			= "~/data/shapes/markers/Eggs/testskin.png";
};

datablock StaticShapeData( CloakMoreEgg : CloakEgg )
{
   className				= "CloakEgg";
   cloakTexture			= "~/data/shapes/markers/Eggs/testskin20alpha.png";
};

datablock StaticShapeData( CloakTotalEgg : CloakEgg )
{
   className				= "CloakEgg";
   cloakTexture			= "~/data/shapes/markers/Eggs/testskin0alpha.png";
};

...
function gsMLTextEdit::onWake( %this ) {
...
function TestMLTextEdit::TestMLTextEditUpdate( %this ) {
	%this.setText ( TestMLTextEditFormat.getValue() @ TestMLTextEditContent.getValue() );
	//%this.forceReflow();
}

...
function BitmapButtonActivator::toggleButtonsActive( %this ) {
...
function ChangeBitmapButtonTheme::onAdd( %this ) {
	%this.logoPath = expandFilename("./" @ %this.theme);
}
...
function ChangeBitmapButtonTheme::onAction( %this ) {
	TestBitmapPushButton.setBitmap(%this.logoPath);

	TestBitmapToggleButton.setBitmap(%this.logoPath);

	TestBitmapRadioButton0.setBitmap(%this.logoPath);
	TestBitmapRadioButton1.setBitmap(%this.logoPath);
	TestBitmapRadioButton2.setBitmap(%this.logoPath);
}

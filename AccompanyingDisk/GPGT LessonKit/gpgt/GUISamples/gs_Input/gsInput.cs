...
function gsInput::onWake( %this ) {
	deviceString.setText("<NULL>");
	actionString.setText("<NULL>");
	makeOrBreak.setText("<NULL>");
	%this.oldDirectInput = $enableDirectInput;
	$enableDirectInput = 1;
	activateDirectInput();
	enableJoystick();
}

function gsInput::onSleep( %this ) {
	$enableDirectInput = %this.oldDirectInput;
...
//
function captureInputs::activateInputCtrl( %this ) {
...
//
function gsTestInputCtrl::onAdd( %this ) 
{
...
function gsTestInputCtrl::onRemove( %this ) 
{
...
//
function gsTestInputCtrl::onInputEvent( %this, %deviceString, %actionString, %makeOrBreak ) {

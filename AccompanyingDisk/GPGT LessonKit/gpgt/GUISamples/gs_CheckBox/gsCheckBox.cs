...
function CheckBoxActivator::toggleButtonsActive( %this ) {
...
function ChangeCheckBoxTheme::onAction( %this ) {
	TestCheckBoxPushButton.setProfile(%this.theme);

	TestCheckBoxToggleButton.setProfile(%this.theme);

	TestCheckBoxRadioButton0.setProfile(%this.theme);
	TestCheckBoxRadioButton1.setProfile(%this.theme);
	TestCheckBoxRadioButton2.setProfile(%this.theme);
}

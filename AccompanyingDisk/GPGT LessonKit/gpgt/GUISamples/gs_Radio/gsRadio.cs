...
function RadioActivator::toggleButtonsActive( %this ) {
...
function ChangeRadioTheme::onAction( %this ) {
	TestRadioPushButton.setProfile(%this.theme);

	TestRadioToggleButton.setProfile(%this.theme);

	TestRadioRadioButton0.setProfile(%this.theme);
	TestRadioRadioButton1.setProfile(%this.theme);
	TestRadioRadioButton2.setProfile(%this.theme);
}

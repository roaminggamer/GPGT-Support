...
function ButtonActivator::toggleButtonsActive( %this ) {
...
function ChangeButtonTheme::onAction( %this ) {
	TestPushButton.setProfile(%this.theme);

	TestToggleButton.setProfile(%this.theme);

	TestRadioButton0.setProfile(%this.theme);
	TestRadioButton1.setProfile(%this.theme);
	TestRadioButton2.setProfile(%this.theme);
}

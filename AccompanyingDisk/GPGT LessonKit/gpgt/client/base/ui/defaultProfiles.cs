...
if(!isObject(GuiDefaultNonModalProfile)) new GuiControlProfile( GuiDefaultNonModalProfile : GuiDefaultProfile )
{
   modal = false;
};
...
if(!isObject(GuiInvisibleSliderProfile)) new GuiControlProfile (GuiInvisibleSliderProfile : GuiSliderProfile)
{
   bitmap = "./invisSlider";
};

if(!isObject(GuiNoBitmapSliderProfile)) new GuiControlProfile (GuiNoBitmapSliderProfile : GuiSliderProfile)
{
   bitmap = "";
   hasBitmapArray = false;
};
...
{
   fillColor = "64 100 100";
};

if(!isObject(GuiCheckBoxProfile2)) new GuiControlProfile (GuiCheckBoxProfile2 )
{
   opaque = true;
   fillColor = "255 255 255";
   border = false;
   ...
   fixedExtent = true;
   justify = "left";
   bitmap = expandFilename("./torqueCheck.png");
   hasBitmapArray = true;
};

new GuiControlProfile (guiSamplerBackFill)
{
   opaque = true;
...
if( !isObject(GuiTabBookProfileOpt) ) new GuiControlProfile (GuiTabBookProfileOpt)
{
	fillColor = "255 255 255";
	fillColorHL = "64 150 150";
	fillColorNA = "150 150 150";
	...
	fontColorNA = "0 0 0";
	justify = "center";
	bitmap = expandFileName("./darkTab");
	tab = true;
	cankeyfocus = true;
	hasBitmapArray = true;
};

if( !isObject(GuiTabPageProfileOpt) ) new GuiControlProfile (GuiTabPageProfileOpt)
{
